...
/*Problem Link -> https://codeforces.com/problemset/problem/1983/C*/
...
void solve()
{
	...
	do {
		...
		int r1 = go(a[fst], 0, need);
		int r2 = go(a[snd], r1 + 1, need);
		int r3 = go(a[trd], r2 + 1, need);

		if (r3 >= n)continue;
		vector<array<int, 3>>res = {{fst, 0, r1}, {snd, r1 + 1, r2}, {trd, r2 + 1, r3}};
